...
def main(
    ...
    codebook_path: Optional[Path] = Path("data/1213_demo_data_v2/codebook.xlsx"),
    iterations: int = 20000,
    lr: float = 0.002,
    exp_name: str = 'cyy_test',
    cali_loss_type: str= 'li',
    weights: list[float] = [0, 1, 0, 0, 0, 0, 0, 0.01],   # l1, l2, lml1, lml2, bg, ssim, scale, code
