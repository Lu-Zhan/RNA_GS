...
if __name__ == "__main__":
    ...
    parser.add_argument("--csv_path", type=str, default=Path("outputs/debug/output_all.csv"))
    parser.add_argument("--img_path", type=str, default=Path("../data/IM41340regi_192"))
